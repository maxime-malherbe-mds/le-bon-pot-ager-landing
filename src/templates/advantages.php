<div class="my-20">
    ...
    <div class="flex justify-center">
        <a id="btn-ios" href="http://itunes.apple.com" target="_blank" class="btn text-center px-8 py-4 text-xl">
            Télécharge l’application dès maintenant !
        </a>
        <a id="btn-android" href="http://play.google.com" target="_blank" class="btn text-center px-8 py-4 text-xl">
            Télécharge l’application dès maintenant !
        </a>
    </div>
</div>